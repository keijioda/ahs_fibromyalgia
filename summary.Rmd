...
* All of the followings were derived from **AHS-1 questionnaire**, except for....
...
* [**Need to check**] Note the number of missing values as well. **How should we handle the missing values?**
