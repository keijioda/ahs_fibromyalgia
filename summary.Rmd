...
* In all the four models, higher odds of developing FM were observed when one or both were perceived cold, but ORs were not statistically significant (OR = 1.25 to 1.39 for one cold parent; 1.58 to 1.71 for both cold)
