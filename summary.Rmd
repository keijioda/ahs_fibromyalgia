...
* ([See the table of unadjusted and adjusted odds ratio here in Excel format](./results/pooled_results_OR_unadj_and_adj_for_demog_xlsx))
...
* **[TO DO]** Consider logistic models including multiple exposure variables simultaneously
